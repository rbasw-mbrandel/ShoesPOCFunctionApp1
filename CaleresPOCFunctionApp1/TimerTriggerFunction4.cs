...
{
    public static class TimerTriggerFunction4
    {
        ...
        [FunctionName("TimerTriggerFunction4")]
        public static void Run([TimerTrigger("0 */1 * * * *")]TimerInfo myTimer, ILogger log, ExecutionContext context)
        {
            ...
            {
                log.LogCritical($"C# Timer trigger function 4 executed at: {DateTime.Now}. Log lvl Critical");
            }
            log.LogInformation($"C# Timer trigger function 4 executed at: {DateTime.Now}. Log lvl Information");
